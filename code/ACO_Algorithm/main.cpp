...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        cerr << "Make sure you have run dataGeneration first to produce " << dataFile << ".\n";
        return 1;
    }

    cout << "Graph loaded: " << graph.size() << " nodes.\n";
    cout << "Start: node 0 at (" << graph[0].x << ", " << graph[0].y << ")\n";
    cout << "Goal : node 299 at (" << graph[299].x << ", " << graph[299].y << ")\n\n";
    ...
    cout << "Best path length (Manhattan distance): " << result.totalCost << "\n";
